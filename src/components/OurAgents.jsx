    ...
    return (
        <div className="max-w-[1440px] mx-auto px-4 pb-24">
            <div className="text-center mb-10">
                <p className="font-medium text-[#ed2027]">OUR TEAMS</p>
                <h1 className="text-4xl font-medium mt-2">Meet Our Agents</h1>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10">
                <div className="space-y-3">
                    <img src="https://themesflat.co/html/homzen/images/agents/agent-1.jpg" className="mx-auto rounded"></img>
